...
function popularfx_scripts() {
	...
	wp_enqueue_style ('theme-style', get_template_directory_uri().'/styles/customArt.css');
	wp_enqueue_style ('theme-style-2', get_template_directory_uri().'/styles/customTom.css');
	/*wp_enqueue_style ('theme-style-3', get_template_directory_uri().'/assets/css/style.css');
	wp_enqueue_style ('theme-style-5', get_template_directory_uri().'/style.css');*/
	...
	wp_enqueue_script( 'popularfx-swiper', get_template_directory_uri().'/js/vendors/swiper.js', array(), POPULARFX_VERSION, true );
	wp_enqueue_script( 'script-custom-art', get_template_directory_uri().'/js/custom-script.js', array(), POPULARFX_VERSION, true );
	wp_enqueue_script( 'script-custom-tom', get_template_directory_uri().'/js/customTomek.js', array(), POPULARFX_VERSION, true );
