<div class="image-text-wrapper" style="background-color:<?php the_field('background_color_image_richtext2') ?>">

    <?php if( get_field('show_waves_image_richtext2') ): ?>
    ...
    <div class="container image-text-wrapper__content" 
        style="<?php if( get_field('layout_setting_image_rich_text2') ): ?> flex-direction:row-reverse <?php endif;?>">

        <div class="image-content">
            <img src="<?php the_field('image_image_richtext2') ?>" alt="logo" >
        </div>
        <div class="text-content">
            <?php the_field('text_image_richtext2') ?>
        </div>
